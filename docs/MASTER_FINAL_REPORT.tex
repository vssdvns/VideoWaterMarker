...
\begin{center}
\vspace*{0.8in}
{\Large\bfseries HYBRID VIDEO WATERMARKING FOR OTT PIRACY PREVENTION USING CONTENT-AWARE PLACEMENT, FORENSIC TRACEABILITY, AND ROBUST DETECTION\par}
\vspace{1.2in}
by\par
\vspace{0.5in}
{\large SubhaSai DurgaVenkata Vinnakota}\par
\vspace{1.2in}
...
by\\
 SubhaSai DurgaVenkata Vinnakota\\
All Rights Reserved
\end{center}
...
\vspace{0.8in}
\noindent
Project Title: \textbf{Hybrid Video Watermarking for OTT Piracy Prevention Using Content-Aware Placement, Forensic Traceability, and Robust Detection}

\vspace{0.8in}
\noindent
Student: SubhaSai DurgaVenkata Vinnakota
...
\noindent
\rule{4.5in}{0.4pt}\\
Dr. Bang Tran S, Committee Chair

\vspace{1.0in}
\noindent
\rule{4.5in}{0.4pt}\\
Dr. Ying Jin, Second Reader
...
\noindent
\rule{4.5in}{0.4pt}\\
Dr. Haiquan Chen, Graduate Coordinator
